...
<h4>REGISTRO HORAS EXTRAS Y DOBLES Y BONIFICACION</h4>
<div class="container">
...
<div class="form-group">
    <label>Empleado</label>
     <select name="id">
        ...
        require '../controlador/conexion.php';
          $checkemail=mysqli_query($conexion,"SELECT IdEmpleado,Nombre,Apellidos FROM empleado where idcargo='18'");
  ...
  <div class="form-group">
    <label>cumplimiento de trabajo</label>
    <input type="number"  class="form-control" name="trabajo" placeholder="Ejemplo: 1 a 100" required="required" >
  </div>
